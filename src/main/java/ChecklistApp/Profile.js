...
function ProfilePage() {
  ...
  function background1() {
    document.getElementById("profile-page").style.background =
      "url('./images/mountain.jpg') no-repeat center";
  ...
  function background2() {
    if (count < 5) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain2.jpg') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
  }
  ...
  function background3() {
    ...
    if (count < 10) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain3.jpg') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
  }
  ...
  function background4() {
    ...
    if (count < 20) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain4.jpg') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
  }
  ...
  function background5() {
    ...
    if (count < 40) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain5.jpg') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
  }
  function background6() {
    if (count < 80) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain6.jpg') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
    //document.body.style.background = "url('./images/mountain3.jpg') no-repeat center";
  ...
  function background7() {
    if (count < 150) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain7.jpg') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
    //document.body.style.background = "url('./images/mountain3.jpg') no-repeat center";
  ...
  function background8() {
    if (count < 200) {
      ...
      document.getElementById("profile-page").style.background =
        "url('./images/mountain8.png') no-repeat center";
      document.getElementById("profile-page").style.backgroundSize = "cover";
      console.log("Button clicked");
    }
    //document.body.style.background = "url('./images/mountain3.jpg') no-repeat center";
  ...
  function UnlockBronzeShieldIcon() {
    if (
      document.getElementById("DisplayBronzeShield").style.display === "none"
    ) {
  ...
  function UnlockSilverShieldIcon() {
    if (
      document.getElementById("DisplaySilverShield").style.display === "none"
    ) {
      ...
      <div className="Grid">
        <div className="ProfileCard">
          ...
          <div className="ProfileFooter">
            <button className="ProfilePageButton" onClick={goToCheckList}>
              {" "}
              Your Checklist{" "}
            </button>
            <button className="ProfilePageButton" onClick={DisplayRewards}>
              {" "}
              Rewards{" "}
            </button>
            <button className="ProfilePageButton" onClick={DisplaySettingModal}>
              {" "}
              Settings{" "}
            </button>
            ...
            <div className="RewardModal" id="RewardsPageModal">
              <div className="RewardsModalBody">
                ...
                <div className="BadgesDisplay">
                  ...
                  Badges Earned
                  <img
                    src="/images/InactiveStar.png"
                    className="InactiveStarClass"
                    onClick={DisplayStars}
                  />
                  <img
                    src="/images/InactiveShield.png"
                    className="InactiveShield"
                    onClick={ShowShields}
                  />
                  <img
                    src="/images/BronzeStar.png"
                    className="BronzeStarBadgeDisplay"
                    id="DisplayBronzeStar"
                  />
                  <img
                    src="/images/SilverStar.png"
                    className="SilverStarBadgeDisplay"
                    id="DisplaySilverStar"
                  />
                  <img
                    src="/images/GoldStar.png"
                    className="GoldStarBadgeDisplay"
                    id="DisplayGoldStar"
                  />
                  <img
                    src="/images/BronzeShield.png"
                    className="BronzeShieldBadgeDisplay"
                    id="DisplayBronzeShield"
                  />
                  <img
                    src="/images/SilverShield.png"
                    className="SilverShieldBadgeDisplay"
                    id="DisplaySilverShield"
                  />
                  <img
                    src="/images/GoldShield.png"
                    className="GoldShieldBadgeDisplay"
                    id="DisplayGoldShield"
                  />
                </div>
                <div className="ShowStar" id="ShowStarModal">
                  <img src="/images/BronzeStar.png" className="BronzeStar" />
                  <button
                    className="UnlockBronzeStar"
                    onClick={UnlockBronzeStar}
                  >
                    {" "}
                    Unlock Bronze Star: 1{" "}
                  </button>

                  <img src="/images/SilverStar.png" className="SilverStar" />
                  <button
                    className="UnlockSilverStar"
                    onClick={UnlockSilverStar}
                  >
                    Unlock Silver Star: 3{" "}
                  </button>

                  <img src="/images/GoldStar.png" className="GoldStar" />
                  <button className="UnlockGoldStar" onClick={UnlockGoldStar}>
                    Unlock Gold Star: 5{" "}
                  </button>
                </div>
                <div className="ShowShield" id="ShowShieldModal">
                  <img
                    src="/images/BronzeShield.png"
                    className="BronzeShield"
                  />
                  <button
                    className="UnlockBronzeShield"
                    onClick={UnlockBronzeShield}
                  >
                    Unlock Bronze Shield: 10{" "}
                  </button>

                  <img
                    src="/images/SilverShield.png"
                    className="SilverShield"
                  />
                  <button
                    className="UnlockSilverShield"
                    onClick={UnlockSilverShield}
                  >
                    Unlock Silver Shield: 20{" "}
                  </button>

                  <img src="/images/GoldShield.png" className="GoldShield" />
                  <button
                    className="UnlockGoldShield"
                    onClick={UnlockGoldShield}
                  >
                    Unlock Gold Shield: 50{" "}
                  </button>
                </div>
            ...
            <div className="SettingsModal" id="SettingsChangeModal">
              <div className="SettingsModalBody">
                ...
                <div className="BackgroundModal" id="BackgroundChangeModal">
                  <button
                    className="BackgroundChooseButton"
                    onClick={background1}
                  >
                    {" "}
                    0{" "}
            ...
            <button className="ProfilePageButton" onClick={goToLogin}>
              {" "}
              Log Out{" "}
            </button>
          </div>
